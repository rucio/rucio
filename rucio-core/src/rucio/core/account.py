...
from rucio.core.db.sqla.constants import AccountStatus, AccountType
...
if TYPE_CHECKING:
    ...
    from rucio.core.common.types import AccountAttributesDict, AccountDict, AccountUsageModelDict, IdentityDict, InternalAccount, UsageDict
