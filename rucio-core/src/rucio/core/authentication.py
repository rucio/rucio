...
from rucio.core.common.exception import CannotAuthenticate, RucioException
from rucio.core.common.utils import chunks, date_to_str, generate_uuid
...
if TYPE_CHECKING:
    ...
    from rucio.core.common.types import InternalAccount, TokenDict, TokenValidationDict
