...
from rucio.core.common.logging import rucio_log_formatter
from rucio.core.common.schema.generic import TIME_ENTRY, UUID, IPv4orIPv6
...
if TYPE_CHECKING:
    ...
    from rucio.core.common.types import TraceSchemaDict
