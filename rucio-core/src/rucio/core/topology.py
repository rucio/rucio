...
from rucio.core.common.exception import InvalidRSEExpression, NoDistance, RSEProtocolNotSupported
from rucio.core.common.utils import PriorityQueue
...
if TYPE_CHECKING:
    ...
    from rucio.core.common.types import HopDict, LoggerFunction
