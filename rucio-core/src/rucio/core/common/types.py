...
if TYPE_CHECKING:
    ...
    from rucio.core.common.constants import SUPPORTED_PROTOCOLS_LITERAL
    from rucio.core.db.sqla.constants import AccountType, IdentityType, ReplicaState, RequestState, RequestType, RSEType
