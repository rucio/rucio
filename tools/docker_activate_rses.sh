...
rucio rse protocol add --host xrd5 --scheme magnet --prefix //rucio --port 10000 --impl rucio.rse.protocols.bittorrent.Default --domain-json '{"wan": {"read": 3, "write": null, "delete": null, "third_party_copy_read": 3, "third_party_copy_write": 3}, "lan": {"read": 3, "write": null, "delete": null}}' XRD5
...
rucio rse protocol add --host web1 --scheme magnet --prefix /var/www/webdav/data/rucio/ --port 10000 --impl rucio.rse.protocols.bittorrent.Default --domain-json '{"wan": {"read": 2, "write": null, "delete": null, "third_party_copy_read": 2, "third_party_copy_write": 2}, "lan": {"read": 2, "write": null, "delete": null}}' WEB1
