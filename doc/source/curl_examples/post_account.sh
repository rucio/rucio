...
curl -s -i --cacert /opt/rucio/etc/web/ca.crt -H "Rucio-Auth-Token: $TOKEN" -H "Rucio-Type: user" -d '{"accountName": "jdoe", "accountType": "user"}' -X POST https://localhost/accounts/
