...
from rucio.tests.common import auth, did_name_generator, headers, skip_multivo
...
class TestOpenDataCore:
    ...
    @skip_multivo(reason="RSE expression evaluation is not working for this test in multivo")
    def test_opendata_dids_update_rule(self, mock_scope, root_account, db_write_session, rse_factory):
