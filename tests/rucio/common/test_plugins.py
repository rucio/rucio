...
from rucio.common.plugins import _get_supported_version_from_policy_package, check_policy_package_version


class TestPolicyPackageVersion:
    def test_get_supported_version_from_policy_package_importerror(self):
        package = 'bad_package'
        with patch('importlib.import_module', side_effect=ImportError):
            with pytest.raises(ImportError):
                _get_supported_version_from_policy_package(package)

    def test_get_supported_version_from_policy_package_not_versioned(self):
    ...
    def test_get_supported_version_from_policy_package(self, module_version, expected_version):
        package = 'versioned_package'
        module = MagicMock()
        module.SUPPORTED_VERSION = module_version
        with patch('importlib.import_module', return_value=module):
            assert _get_supported_version_from_policy_package(package) == expected_version
    ...
    def test_check_policy_package_version_exceptions(self, raised_exception):
        package = 'bad_package'
        with patch('rucio.common.plugins._get_supported_version_from_policy_package', side_effect=raised_exception):
    ...
    def test_check_policy_package_version_supported(self):
        ...
        with patch('rucio.common.plugins._get_supported_version_from_policy_package', return_value=['1.0', '2.0']):
            with patch('rucio.common.plugins.current_version', return_value='2.0'):
                assert check_policy_package_version(package) is None
    ...
    def test_check_policy_package_version_unsupported(self):
        ...
        with patch('rucio.common.plugins._get_supported_version_from_policy_package', return_value=supported_versions):
            with patch('rucio.common.plugins.current_version', return_value=rucio_version):
                ...
                assert e.value.supported_versions == supported_versions
