...
def downgrade():
    ...
    schema = context.get_context().version_table_schema if context.get_context().version_table_schema else ''
    drop_column('replicas', 'availability', schema=schema)
    drop_column('dids', 'availability', schema=schema)
    drop_column('deleted_dids', 'availability', schema=schema)
    drop_column('quarantined_replicas', 'availability', schema=schema)
    drop_column('quarantined_replicas_history', 'availability', schema=schema)
    drop_column('contents', 'availability', schema=schema)
    drop_column('archive_contents', 'availability', schema=schema)
    drop_column('archive_contents_history', 'availability', schema=schema)
    drop_column('contents_history', 'availability', schema=schema)
    drop_column('requests', 'availability', schema=schema)
    drop_column('requests_history', 'availability', schema=schema)
