...
@read_session
def sections(issuer: Optional[str] = None, vo: str = DEFAULT_VO, *, session: "Session") -> list[str]:
    """
...
def add_section(section: str, issuer: Optional[str] = None, vo: str = DEFAULT_VO, *, session: "Session") -> None:
    """
...
@read_session
def has_section(section: str, issuer: Optional[str] = None, vo: str = DEFAULT_VO, *, session: "Session") -> bool:
    """
...
@read_session
def options(section: str, issuer: Optional[str] = None, vo: str = DEFAULT_VO, *, session: "Session") -> list[str]:
    """
...
@read_session
def has_option(section: str, option: str, issuer: Optional[str] = None, vo: str = DEFAULT_VO, *, session: "Session") -> bool:
    """
...
@read_session
def get(section: str, option: str, issuer: Optional[str] = None, vo: str = DEFAULT_VO, *, session: "Session") -> Any:
    """
...
@read_session
def items(section: str, issuer: Optional[str] = None, vo: str = DEFAULT_VO, *, session: "Session") -> list[tuple[str, Any]]:
    """
...
@transactional_session
def set(section: str, option: str, value: Any, issuer: Optional[str] = None, vo: str = DEFAULT_VO, *, session: "Session") -> None:
    """
...
@transactional_session
def remove_section(section: str, issuer: Optional[str] = None, vo: str = DEFAULT_VO, *, session: "Session") -> bool:
    """
...
@transactional_session
def remove_option(section: str, option: str, issuer: Optional[str] = None, vo: str = DEFAULT_VO, *, session: "Session") -> bool:
    """
