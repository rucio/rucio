...
class TestAuthorisation(object):
    ...
    def test_sign_url_gcs(self):
        ...
        assert_equal(get_signed_url('gcs', 'read', 'http://storage/directory/file', expires_at=0),
        ...
        assert_equal(get_signed_url('gcs', 'write', 'http://storage/directory/file', expires_at=0),
                     'https://storage.googleapis.com/directory/file?GoogleAccessId=rucio-test@rucio-test'
        ...
        assert_equal(get_signed_url('gcs', 'delete', 'http://storage/directory/file', expires_at=0),
                     'https://storage.googleapis.com/directory/file?GoogleAccessId=rucio-test@rucio-test'
