...
class MgrTestCases():
    ...
    def test_get_mgr_SourceNotFound_multi(self):
        ...
        status, details = self.mgr.download(self.rse_tag, [{'filename': '1_not_existing_data.raw', 'scope': 'user.jdoe'},
                                                           {'filename': '1_rse_remote_get.raw', 'scope': 'user.jdoe'},
                                                           {'filename': '2_not_existing_data.raw', 'scope': 'user.jdoe', 'pfn': 'user/jdoe/no/ex/2_not_existing_data.raw'},
                                                           {'filename': '2_rse_remote_get.raw', 'scope': 'user.jdoe', 'pfn': 'user/jdoe/d7/bc/2_rse_remote_get.raw'}], self.tmpdir)
        if details['user.jdoe:1_rse_remote_get.raw'] and details['user.jdoe:2_rse_remote_get.raw']:
            if details['user.jdoe:1_not_existing_data.raw'].__class__.__name__ == 'SourceNotFound' and details['user.jdoe:2_not_existing_data.raw'].__class__.__name__ == 'SourceNotFound':
    ...
    def test_exists_mgr_ok_multi(self):
        ...
        status, details = self.mgr.exists(self.rse_tag, [{'filename': '1_rse_remote_get.raw', 'scope': 'user.jdoe'},
                                                         {'filename': '2_rse_remote_get.raw', 'scope': 'user.jdoe'},
                                                         {'filename': 'user/jdoe/5a/98/3_rse_remote_get.raw'},
                                                         {'filename': 'user/jdoe/fb/6a/4_rse_remote_get.raw'}])
    ...
    def test_exists_mgr_false_multi(self):
        ...
        status, details = self.mgr.exists(self.rse_tag, [{'filename': '1_rse_remote_get.raw', 'scope': 'user.jdoe'},
                                                         {'filename': 'not_existing_data.raw', 'scope': 'user.jdoe'},
                                                         {'filename': 'user/jdoe/d7/bc/2_rse_remote_get.raw'},
                                                         {'filename': 'user/jdoe/21/5e/1_rse_not_existing.raw'}])
    ...
    def test_rename_mgr_ok_multi(self):
        ...
        status, details = self.mgr.rename(self.rse_tag, [{'filename': '1_rse_remote_rename.raw', 'scope': 'user.jdoe', 'new_filename': '1_rse_new.raw'},
                                                         {'filename': '2_rse_remote_rename.raw', 'scope': 'user.jdoe', 'new_filename': '2_rse_new.raw'},
                                                         {'filename': 'user/jdoe/84/a1/7_rse_remote_rename.raw', 'new_filename': 'user/jdoe/c4/61/7_rse_new.raw'},
                                                         {'filename': 'user/jdoe/90/97/8_rse_remote_rename.raw', 'new_filename': 'user/jdoe/4c/fd/8_rse_new.raw'}])
    ...
    def test_rename_mgr_FileReplicaAlreadyExists_multi(self):
        ...
        status, details = self.mgr.rename(self.rse_tag, [{'filename': '4_rse_remote_rename.raw', 'scope': 'user.jdoe', 'new_filename': '1_rse_remote_get.raw', 'new_scope': 'user.jdoe'},
                                                         ...
                                                         {'filename': 'user/jdoe/fa/50/10_rse_remote_rename.raw', 'new_filename': 'user/jdoe/59/bd/1_rse_remote_get.raw'},
                                                         {'filename': 'user/jdoe/73/23/11_rse_remote_rename.raw', 'new_filename': 'user/jdoe/5b/46/11_rse_new.raw'}])
    ...
    def test_rename_mgr_SourceNotFound_multi(self):
        ...
        status, details = self.mgr.rename(self.rse_tag, [{'filename': '1_rse_not_existing.raw', 'scope': 'user.jdoe', 'new_filename': '1_rse_new_not_created.raw'},
                                                         {'filename': 'user/jdoe/77/d4/2_rse_not_existing.raw', 'new_filename': 'user/jdoe/65/e3/2_rse_new_not_created.raw'}])
