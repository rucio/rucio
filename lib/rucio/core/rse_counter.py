...
def update_replica_counts(rse_id, session=None):
    ...
    obsolete_files, obsolete_bytes = (session.query(func.count(), func.sum(models.RSEFileAssociation.bytes))
                                      ...
                                      .one())
    deletable_files, deletable_bytes = (session.query(func.count(), func.sum(models.RSEFileAssociation.bytes))
                                        .filter(models.RSEFileAssociation.rse_id == rse_id,
                                                models.RSEFileAssociation.tombstone != null(),
