...
def perm_send_heartbeats(issuer: "InternalAccount", kwargs: "Dict[str, Any]", *, session: "Optional[Session]" = None) -> bool:
    """
...
def perm_get_ssh_challenge_token(issuer: "InternalAccount", kwargs: "Dict[str, Any]", *, session: "Optional[Session]" = None) -> bool:
    """
...
def perm_add_vo(issuer: "InternalAccount", kwargs: "Dict[str, Any]", *, session: "Optional[Session]" = None) -> bool:
    """
...
def perm_list_vos(issuer: "InternalAccount", kwargs: "Dict[str, Any]", *, session: "Optional[Session]" = None) -> bool:
    """
...
def perm_recover_vo_root_identity(issuer: "InternalAccount", kwargs: "Dict[str, Any]", *, session: "Optional[Session]" = None) -> bool:
    """
...
def perm_update_vo(issuer: "InternalAccount", kwargs: "Dict[str, Any]", *, session: "Optional[Session]" = None) -> bool:
    """
...
def perm_access_rule_vo(issuer: "InternalAccount", kwargs: "Dict[str, Any]", *, session: "Optional[Session]" = None) -> bool:
    """
