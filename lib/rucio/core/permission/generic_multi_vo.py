...
def has_permission(issuer, action, kwargs, session: "Session"):
    """
...
def perm_default(issuer, kwargs, session: "Session"):
    """
    Default permission.
...
def perm_add_rse(issuer, kwargs, session: "Session"):
    """
...
def perm_update_rse(issuer, kwargs, session: "Session"):
    """
...
def perm_add_rule(issuer, kwargs, session: "Session"):
    """
...
def perm_add_subscription(issuer, kwargs, session: "Session"):
    """
...
def perm_add_rse_attribute(issuer, kwargs, session: "Session"):
    """
...
def perm_del_rse_attribute(issuer, kwargs, session: "Session"):
    """
...
def perm_del_rse(issuer, kwargs, session: "Session"):
    """
...
def perm_add_account(issuer, kwargs, session: "Session"):
    """
...
def perm_del_account(issuer, kwargs, session: "Session"):
    """
...
def perm_update_account(issuer, kwargs, session: "Session"):
    """
...
def perm_add_scope(issuer, kwargs, session: "Session"):
    """
...
def perm_get_auth_token_gss(issuer, kwargs, session: "Session"):
    """
    Checks if a user can request a token with user_pass for an account.
...
def perm_get_auth_token_x509(issuer, kwargs, session: "Session"):
    """
    Checks if a user can request a token with user_pass for an account.
...
def perm_add_account_identity(issuer, kwargs, session: "Session"):
    """
...
def perm_del_account_identity(issuer, kwargs, session: "Session"):
    """
...
def perm_del_identity(issuer, kwargs, session: "Session"):
    """
...
def perm_add_did(issuer, kwargs, session: "Session"):
    """
...
def perm_add_dids(issuer, kwargs, session: "Session"):
    """
...
def perm_attach_dids(issuer, kwargs, session: "Session"):
    """
...
def perm_attach_dids_to_dids(issuer, kwargs, session: "Session"):
    """
    Checks if an account can append an data identifier to the other data identifier.
...
def perm_create_did_sample(issuer, kwargs, session: "Session"):
    """
...
def perm_del_rule(issuer, kwargs, session: "Session"):
    """
...
def perm_update_rule(issuer, kwargs, session: "Session"):
    """
...
def perm_approve_rule(issuer, kwargs, session: "Session"):
    """
...
def perm_reduce_rule(issuer, kwargs, session: "Session"):
    """
...
def perm_move_rule(issuer, kwargs, session: "Session"):
    """
...
def perm_update_subscription(issuer, kwargs, session: "Session"):
    """
...
def perm_detach_dids(issuer, kwargs, session: "Session"):
    """
...
def perm_set_metadata(issuer, kwargs, session: "Session"):
    """
...
def perm_del_protocol(issuer, kwargs, session: "Session"):
    """
...
def perm_update_protocol(issuer, kwargs, session: "Session"):
    """
...
def perm_declare_bad_file_replicas(issuer, kwargs, session: "Session"):
    """
...
def perm_declare_suspicious_file_replicas(issuer, kwargs, session: "Session"):
    """
...
def perm_add_replicas(issuer, kwargs, session: "Session"):
    """
...
def perm_delete_replicas(issuer, kwargs, session: "Session"):
    """
...
def perm_list_requests(issuer, kwargs, session: "Session"):
    """
...
def perm_list_requests_history(issuer, kwargs, session: "Session"):
    """
...
def perm_get_request_by_did(issuer, kwargs, session: "Session"):
    """
...
def perm_cancel_request(issuer, kwargs, session: "Session"):
    """
...
def perm_get_next(issuer, kwargs, session: "Session"):
    """
...
def perm_set_rse_usage(issuer, kwargs, session: "Session"):
    """
...
def perm_set_rse_limits(issuer, kwargs, session: "Session"):
    """
...
def perm_set_local_account_limit(issuer, kwargs, session: "Session"):
    """
...
def perm_set_global_account_limit(issuer, kwargs, session: "Session"):
    """
...
def perm_delete_local_account_limit(issuer, kwargs, session: "Session"):
    """
...
def perm_delete_global_account_limit(issuer, kwargs, session: "Session"):
    """
...
def perm_config(issuer, kwargs, session: "Session"):
    """
...
def perm_get_local_account_usage(issuer, kwargs, session: "Session"):
    """
...
def perm_get_global_account_usage(issuer, kwargs, session: "Session"):
    """
    Checks if an account can get the account usage of an account.
...
def perm_add_account_attribute(issuer, kwargs, session: "Session"):
    """
...
def perm_del_account_attribute(issuer, kwargs, session: "Session"):
    """
    Checks if an account can add attributes to accounts.
...
def perm_list_heartbeats(issuer, kwargs, session: "Session"):
    """
...
def perm_resurrect(issuer, kwargs, session: "Session"):
    """
...
def perm_update_lifetime_exceptions(issuer, kwargs, session: "Session"):
    """
...
def perm_get_signed_url(issuer, kwargs, session: "Session"):
    """
    ...
    :returns: True if account is allowed to call the API call, otherwise False
    """
    return _is_root(issuer) or has_account_attribute(account=issuer, key='sign-url', session=session)
...
def perm_remove_did_from_followed(issuer, kwargs, session: "Session"):
    """
...
def perm_remove_dids_from_followed(issuer, kwargs, session: "Session"):
    """
...
def perm_list_vos(issuer, kwargs, session: "Session"):
    """
...
def perm_recover_vo_root_identity(issuer, kwargs, session: "Session"):
    """
...
def perm_update_vo(issuer, kwargs, session: "Session"):
    """
...
def perm_access_rule_vo(issuer, kwargs, session: "Session"):
    """
