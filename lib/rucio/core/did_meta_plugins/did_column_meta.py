...
class DidColumnMeta(DidMetaPlugin):
    ...
    @read_session
    def get_metadata(self, scope: "InternalScope", name: str, *, session: "Session") -> "dict[str, Any]":
        """
        ...
        try:
            ...
            opendata_table_exists = session.get_bind() is not None and inspect(session.get_bind()).has_table(
                models.OpenDataDid.__tablename__)
