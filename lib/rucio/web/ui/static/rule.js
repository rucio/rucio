                                         ...
                                         if (data[sorted_keys[i]] != undefined) {
                                             if (typeof data[sorted_keys[i]] === 'boolean'){
                                                 ...
                                                 if (sorted_keys[i] == 'expires_at') {
                                                     data[sorted_keys[i]] += ' <a><i title="Extend expiration date" id="change_date" class="step fi-widget size-18"></i></a> <a><i title="Remove expiration date" id="clear_date" class="step fi-x size-18"></i></a>';
                                                 }
