...
function RucioClient(token, account) {
    ...
    this.url = 'https://rucio-ui.cern.ch:443/proxy';
    this.authurl = 'https://rucio-ui.cern.ch:443/authproxy';
    this.dumps = 'https://rucio-ui.cern.ch:443/dumpsproxy';
};
...
RucioClient.prototype.get_auth_token_x509 = function(options) {
    jQuery.ajax({url: this.authurl + '/auth/x509',
                 crossDomain: true,
