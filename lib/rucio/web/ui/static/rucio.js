...
/* get local limits for an account */
RucioClient.prototype.get_local_account_limits = function(options) {
    check_token();
    if (options.async == null) { options.async = true; }
    jQuery.ajax({url: this.url + '/accounts/' + options.account + '/limits/local',
                 crossDomain: true,
                 headers: this.headers,
                 dataType: 'text',
                 async: options.async,
...
/* get global limits for an account */
RucioClient.prototype.get_global_account_limits = function(options) {
    check_token();
    if (options.async == null) { options.async = true; }
    jQuery.ajax({url: this.url + '/accounts/' + options.account + '/limits/global',
                 crossDomain: true,
                 headers: this.headers,
                 dataType: 'text',
                 async: options.async,
...
RucioClient.prototype.get_local_account_usage = function(options) {
    check_token();
    var url = this.url + '/accounts/' + options.account + '/usage/local';
...
RucioClient.prototype.get_global_account_usage = function(options) {
    check_token();
    var url = this.url + '/accounts/' + options.account + '/usage/global';
    if (options.async == null) { options.async = true; }
    jQuery.ajax({url: url,
                 crossDomain: true,
                 headers: this.headers,
