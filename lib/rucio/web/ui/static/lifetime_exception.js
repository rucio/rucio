            ...
            $.when(d).done(function(){
                if (get_datasets){
                    for (idx = 0; idx < list_dids.length; idx++){
                        ...
                        datasets_array.push($('<option></option>', {'value': res[0], 'id': idx}).text(res[0]));
                    }
              ...
              Yes: function(){
                 ...
                 r.create_lifetime_exception({
                     ...
                     error: function(jqXHR, textStatus, errorThrown) {
                         ...
                         alertBox.empty();
                         alertBox.append($('<div data-alert></div>', {'class': 'alert-box alert radius'}).text('Problem to create the exception : ' + errorThrown));
                     }
                 });
              },
              Cancel: function() {
