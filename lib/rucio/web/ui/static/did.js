                                                 ...
                                                 success: function(rules) {
                                                     if (rules != '') {
                                                         ...
                                                         rules.forEach(function(r) {
                                                             ...
                                                             if (r.state == 'OK') {
                                                                 r.state = "<font color=green>" + r.state + "</font>";
                                                             } else if (r.state == 'REPLICATING') {
                                                                 r.state = "<font color=orange>" + r.state + "</font>";
                                                             } else if (r.state == 'STUCK') {
                                                                 r.state = "<font color=RED>" + r.state + "</font>";
                                                             }
