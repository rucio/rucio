            ...
            $.each(replicas, function(index, replica) {
                ...
                $.each(sorted_rses, function(index, rse) {
                    ...
                    if (browser_enabled_rses.indexOf(rse) != -1){
                        str_rses += rse + "<a href=\"" + dav_replicas[0]['rses'][rse][0].replace("davs", "https") + "\" target=\"blank\">  <i title=\"Click to download this file from " + rse  + ".\" class=\"fi-download size-18\"></i></a>";
    		        } else {
                        str_rses += rse;
			}
