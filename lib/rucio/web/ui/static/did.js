                            ...
                            if (state == 'AVAILABLE') {
                                ...
                                try{
                                    if (browser_enabled_rses.indexOf(rse) != -1 && !blacklisted){
                                        ...
                                        str_rses += rse + " <a href=\"#\" onclick=\"move_did('" + replica['scope'] + "','" + replica['name'] + "',false,1);return false;\" style=\"color: rgb(128,128,128)\"><i title=\"This RSE is not WebDAV-enabled. Click here to move the file to a WebDAV-enabled RSE.\" class=\"fi-download size-18\"></i></a>";
                                    }
                                } catch(err) {
