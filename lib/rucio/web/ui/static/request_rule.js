...
create_rules = function(approval) {
    ...
    options['error'] = function(jqXHR, textStatus, errorThrown) {
        ...
        if (error_details['ExceptionClass'] == 'DuplicateRule') {
            ...
            html_check = '<font color="red">The RSE that you chose is currently not available for writing. Please check <a href="http://atlas-agis.cern.ch/agis/ddmblacklisting/list/" target="_blank">here</a> for more information.</font>';
        } else {
