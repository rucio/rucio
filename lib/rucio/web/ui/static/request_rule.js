...
create_did_list = function(scope, dids) {
    var html = '            <div class="row">        <div id="did_table" class="large-12 columns">          <div> <table id="dt_list_dids" class="compact stripe order-column" style="word-wrap: break-word;"><thead><th>Name</th></thead><tfoot><th>Name</th></tfoot></table>        </div> </div>      </div>      <div class="row">        <!--<div class="large-2 columns">            <a class="button postfix" id="selectall_button">Select All</a>        </div>-->        <div class="large-2 columns">          <a class="button postfix" id="continue_button">Continue</a>        </div>  <div id="did_problem" class="large-3 columns"></div>       <div class="large-7 columns">        </div>      </div>';
    ...
    $('#dt_list_dids').on( 'click', 'tr', function () {
            $(this).toggleClass('selected');
        } );

    $('#selectall_button').on('click', function() {
            console.log(dt);
            $.each(dt.fnGetNodes, function(index, row) {
        ...
        success: function(data) {
            ...
            if (data.length == 0) {
                ...
                if (sum_bytes > data[0]['bytes_remaining']) {
                    ...
                    html_check = '<font color="green">All ok, rule is now created</font>';
                    create_rule();
                }
            }
...
create_rule = function() {
    ...
    options['error'] = function(jqXHR, textStatus, errorThrown) {
        html_check = '<font color="red">' + textStatus + '</font>';
        console.log(jqXHR);
    };
