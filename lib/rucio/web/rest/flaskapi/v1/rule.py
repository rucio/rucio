...
class Rule(MethodView):
    ...
    def put(self, rule_id):
        ...
        try:
            ...
            return generate_http_error_flask(404, 'AccountNotFound', error.args[0][0])
    ...
    def delete(self, rule_id):
        ...
        try:
            ...
            return generate_http_error_flask(401, 'UnsupportedOperation', error.args[0][0])
        except RuleNotFound as error:
            return generate_http_error_flask(404, 'RuleNotFound', error.args[0][0])
...
class AllRule(MethodView):
    ...
    def post(self):
        ...
        # TODO: Add all other error cases here
            ...
            return generate_http_error_flask(409, 'InvalidReplicationRule', error.args[0][0])
            ...
            return generate_http_error_flask(409, 'InsufficientTargetRSEs', error.args[0][0])
        except InsufficientAccountLimit as error:
            return generate_http_error_flask(409, 'InsufficientAccountLimit', error.args[0][0])
        except InvalidRSEExpression as error:
            return generate_http_error_flask(409, 'InvalidRSEExpression', error.args[0][0])
            ...
            return generate_http_error_flask(409, 'ReplicationRuleCreationTemporaryFailed', error.args[0][0])
        except InvalidRuleWeight as error:
            return generate_http_error_flask(409, 'InvalidRuleWeight', error.args[0][0])
...
class ReduceRule(MethodView):
    ...
    def post(self, rule_id):
        ...
        # TODO: Add all other error cases here
            ...
            return generate_http_error_flask(409, 'RuleReplaceFailed', error.args[0][0])
        except RuleNotFound as error:
            return generate_http_error_flask(404, 'RuleNotFound', error.args[0][0])
        except RucioException as error:
            return generate_http_error_flask(500, error.__class__.__name__, error.args[0])
