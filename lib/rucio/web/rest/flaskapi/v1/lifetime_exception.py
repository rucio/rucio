...
class LifetimeException(MethodView):
    ...
    def get(self):
        ...
        try:
            ...
            return generate_http_error_flask(404, 'LifetimeExceptionNotFound', error.args[0][0])
    ...
    def post(self):
        ...
        try:
            ...
            return generate_http_error_flask(409, 'LifetimeExceptionDuplicate', error.args[0][0])
        except RucioException as error:
...
class LifetimeExceptionId(MethodView):
    ...
    def put(self, exception_id):
        ...
        try:
            ...
            return generate_http_error_flask(400, 'UnsupportedOperation', error[0][0])
        except AccessDenied as error:
            return generate_http_error_flask(401, 'AccessDenied', error.args[0][0])
        except LifetimeExceptionNotFound as error:
            return generate_http_error_flask(404, 'LifetimeExceptionNotFound', error[0][0])
        except RucioException as error:
            return generate_http_error_flask(500, error.__class__.__name__, error.args[0])
        except Exception as error:
            return error, 500
