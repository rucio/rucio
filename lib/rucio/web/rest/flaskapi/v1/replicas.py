...
class Replicas(ErrorHandlingMethodView):
    ...
    def get(self, scope_name):
        ...
        client_location: 'IPDict' = {'ip': client_ip, 'fqdn': None, 'site': None}  # type: ignore (ip could be None)
...
class ListReplicas(ErrorHandlingMethodView):
    ...
    def post(self):
        ...
        client_location: 'IPDict' = {'ip': client_ip,  # type: ignore (ip could be None)
                                     'fqdn': None,
                                     'site': None}
        client_location.update(param_get(parameters, 'client_location', default={}))

        # making sure IP address is not overwritten
        client_location['ip'] = client_ip  # type: ignore (ip could be None)
