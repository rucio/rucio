...
class Plans(ErrorHandlingMethodView):
    ...
    def get(self, src_rse: Optional[str] = None, dest_rse: Optional[str] = None) -> Union[str, Response]:
        """
        ---
        ...
        try:
            if src_rse and dest_rse:
                ...
                def generate(vo: Optional[str]) -> "Iterator[str]":
    ...
    def delete(self, src_rse: str, dest_rse: str) -> 'ResponseReturnValue':
        """
        ---
    ...
    def put(self, src_rse: str, dest_rse: str) -> 'ResponseReturnValue':
        """
        ---
...
class Kill(ErrorHandlingMethodView):
    ...
    def post(self, src_rse: str, dest_rse: str) -> 'ResponseReturnValue':
        """
        ---
