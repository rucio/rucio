...
class StompConnectionManager:
    ...
    def _parse_config(self, config_section: str) -> StompConfig:
        ...
        key_file = config_get(config_section, 'ssl_key_file', raise_exception=False)
        cert_file = config_get(config_section, 'ssl_cert_file', raise_exception=False)
        username = config_get(config_section, 'username', raise_exception=False)
        password = config_get(config_section, 'password', raise_exception=False)
        nonssl_port = config_get_int(config_section, 'nonssl_port', default=0)
        timeout = config_get_float(config_section, 'timeout', raise_exception=False)
