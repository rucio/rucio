...
class ConfigOption:
    def __init__(self, section: str, name: str, docstring: str, type_: 'Callable[[str], _U]' = str, default: '_U' = None) -> None:
        """
        Define the option string for a config entry
        Includes the docstring, type, and default for documentation purposes
        """
    ...
    def __call__(self, **kwargs) -> 'Any':
        ...
        elif isinstance(self.type_, bool):
            self.type_ = _convert_to_boolean

        # If "default" is set, overwrite the default set at initialization
