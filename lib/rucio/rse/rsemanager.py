...
from rucio.common.constants import RSE_SUPPORTED_PROTOCOL_OPERATIONS, RSE_SUPPORTED_PROTOCOL_OPERATIONS_LITERAL
...
def create_protocol(
    ...
    operation = cast(RSE_SUPPORTED_PROTOCOL_OPERATIONS_LITERAL, operation)
