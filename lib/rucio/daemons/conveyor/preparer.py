...
def run(once=False, threads=1, sleep_time=10, bulk=100, ignore_availability=False):
    """
...
def preparer(once, sleep_time, bulk, ignore_availability, partition_wait_time=10):
