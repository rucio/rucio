...
def run_once(heartbeat_handler, bulk, **_kwargs):
    ...
    try:
        ...
        for did in list_new_dids(thread=worker_number, total_threads=total_workers, chunk_size=bulk, did_type=None):
                    ...
                    if is_matching_subscription(subscription, did, metadata) is True:
                        ...
                        for rule_dict in rules:
                            ...
                            if chained_idx:
                                ...
                                logger(logging.DEBUG, 'Chained subscription identified. Will use %s', str(created_rules[chained_idx]))
