...
from rucio.common.dumper import HTTPDownloadFailed, http_download_to_file, gfal_download_to_file, ddmendpoint_url, temp_file
...
protocol_funcs = {
    ...
    'http': {
        'links': http_links,
        'download': functools.partial(http_download_to_file, force_decode=True),
    },
    'https': {
        'links': http_links,
        'download': functools.partial(http_download_to_file, force_decode=True),
