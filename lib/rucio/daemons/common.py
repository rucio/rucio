...
class BaseDaemon:
    ...
    def __init__(self, daemon_name: str = "undefined_daemon", once: bool = False, total_workers: int = 1, chunk_size: int = 10, sleep_time: int = 60, partition_wait_time: int = 1) -> None:
