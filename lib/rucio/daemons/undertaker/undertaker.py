...
from rucio.daemons.common import BaseDaemon, run_daemon, HeartbeatHandler
...
class Undertaker(BaseDaemon):
    def __init__(self):
        super().__init__(daemon_name="undertaker")
        self.paused_dids = {}

    def _run_once(self, heartbeat_handler: HeartbeatHandler, **_kwargs):
