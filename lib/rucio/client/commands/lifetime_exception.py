...
class LifetimeException(CommandBase):
    ...
    def usage_example(self) -> list[str]:
        return ["$ rucio lifetime-exception --inputfile myfile.txt --reason 'Needed for my analysis' --expiration 2015-10-30  # Add exceptions for all DIDs listed in myfile.txt"]
    ...
    def add(self):
        add_lifetime_exception(self.args, self.client, self.logger)
