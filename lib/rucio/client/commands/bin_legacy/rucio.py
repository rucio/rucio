...
@exception_handler
def whoami_account(args, client, logger):
    """
...
@exception_handler
def list_dataset_replicas(args, client, logger):
    """
...
@exception_handler
def list_file_replicas(args, client, logger):
    """
    %(prog)s list [options] <field1=value1 field2=value2 ...>
...
@exception_handler
def add_dataset(args, client, logger):
    """
...
@exception_handler
def add_container(args, client, logger):
    """
...
@exception_handler
def list_dids(args, client, logger):
    """
...
@exception_handler
def list_dids_extended(args, client, logger):
    """
...
@exception_handler
def list_files(args, client, logger):
    """
...
@exception_handler
def list_content(args, client, logger):
    """
...
@exception_handler
def list_content_history(args, client, logger):
    """
...
@exception_handler
def list_parent_dids(args, client, logger):
    """
...
@exception_handler
def download(args, client, logger):
    """
...
@exception_handler
def get_metadata(args, client, logger):
    """
...
@exception_handler
def set_metadata(args, client, logger):
    """
...
@exception_handler
def delete_metadata(args, client, logger):
    """
    %(prog)s set_metadata [options] <field1=value1 field2=value2 ...>
...
@exception_handler
def add_rule(args, client, logger):
    """
...
@exception_handler
def delete_rule(args, client, logger):
    """
...
@exception_handler
def update_rule(args, client, logger):
    """
...
@exception_handler
def move_rule(args, client, logger):
    """
...
@exception_handler
def info_rule(args, client, logger):
    """
...
@exception_handler
def list_rules(args, client, logger):
    """
    %(prog)s list-rules ...
...
@exception_handler
def list_rules_history(args, client, logger):
    """
...
@exception_handler
def list_suspicious_replicas(args, client, logger):
    """
...
@exception_handler
def list_rse_attributes(args, client, logger):
    """
...
@exception_handler
def list_rse_usage(args, client, logger):
    """
...
@exception_handler
def list_account_limits(args, client, logger):
    """
    %(prog)s list [options] <field1=value1 field2=value2 ...>
...
@exception_handler
def list_account_usage(args, client, logger):
    """
    %(prog)s list [options] <field1=value1 field2=value2 ...>
...
@exception_handler
def list_datasets_rse(args, client, logger):
    """
    %(prog)s list [options] <field1=value1 field2=value2 ...>
...
@exception_handler
def add_lifetime_exception(args, client, logger):
    """
...
def test_server(args, client, logger):
    """"
...
def main():
    ...
    result = args.function(args, client, logger)
    end_time = time.time()
    if args.verbose:
