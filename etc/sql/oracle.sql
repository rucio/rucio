...
-- Date: Mon May 27 09:10:27 CEST 2013
...
CREATE TABLE did_attributes (
	...
	updated_at DATE,
	created_at DATE,
	CONSTRAINT "DID_ATTRIBUTES_PK" PRIMARY KEY (scope, name, key) USING INDEX LOCAL,
...
CREATE TABLE replicas (
	...
	CONSTRAINT "REPLICAS_SIZE_NN" CHECK ("size" IS NOT NULL),
	CONSTRAINT "REPLICAS_CREATED_NN" CHECK ("CREATED_AT" IS NOT NULL),
	CONSTRAINT "REPLICAS_UPDATED_NN" CHECK ("UPDATED_AT" IS NOT NULL),
	CONSTRAINT "REPLICAS_STATE_CHK" CHECK (state IN ('AVAILABLE', 'COPYING', 'BEING_DELETED', 'UNAVAILABLE', 'BAD'))
) PCTFREE 0
...
CREATE TABLE contents (
	...
	updated_at DATE,
	created_at DATE,
	CONSTRAINT "CONTENTS_PK" PRIMARY KEY (scope, name, child_scope, child_name)  USING INDEX LOCAL,
