...
BEGIN        
	...
	-- ver 1.0
        INSERT INTO DELETED_DIDS (SCOPE, NAME, ACCOUNT, DID_TYPE, 
                                  ...
                                  RULE_EVALUATION_REQUIRED, RULE_EVALUATION_ACTION, EXPIRED_AT, 
                                  DELETED_AT, UPDATED_AT, CREATED_AT, EVENTS, GUID, PROJECT, 
                                 ...
                                 (:OLD.SCOPE, :OLD.NAME, :OLD.ACCOUNT, :OLD.DID_TYPE, 
                                  ...
                                  :OLD.RULE_EVALUATION_REQUIRED, :OLD.RULE_EVALUATION_ACTION, :OLD.EXPIRED_AT, 
                                  sys_extract_utc(systimestamp), :OLD.UPDATED_AT, :OLD.CREATED_AT, :OLD.EVENTS, :OLD.GUID, :OLD.PROJECT, 
