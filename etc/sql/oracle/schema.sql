  ...
  CREATE TABLE IDENTITIES 
   (	IDENTITY VARCHAR2(2048), 
	...
	SALT BLOB, 
	 ...
	 CONSTRAINT IDENTITIES_TYPE_CHK CHECK (identity_type IN ('X509', 'GSS', 'USERPASS', 'SSH', 'OIDC')), 
  ...
  CREATE TABLE ACCOUNT_MAP 
   (	IDENTITY VARCHAR2(2048), 
	...
	CREATED_AT DATE, 
	 ...
	 CONSTRAINT ACCOUNT_MAP_IS_TYPE_CHK CHECK (identity_type IN ('X509', 'GSS', 'USERPASS', 'SSH', 'OIDC')) , 
