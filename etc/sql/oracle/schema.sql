...
) PCTFREE 0 COMPRESS 1 TABLESPACE ATLAS_RUCIO_FACT_DATA01;
...
CREATE TABLE QUARANTINED_REPLICAS_HISTORY (
	...
	created_at DATE,
	deleted_at DATE
) PCTFREE 0 COMPRESS 1 TABLESPACE ATLAS_RUCIO_HIST_DATA01
PARTITION BY RANGE(created_at)
INTERVAL ( NUMTOYMINTERVAL(1,'MONTH') )
( PARTITION "DATA_BEFORE_01032015" VALUES LESS THAN (TO_DATE('01-03-2016', 'DD-MM-YYYY')) );
