  ...
  CREATE TABLE IDENTITIES
   (	IDENTITY VARCHAR2(2048),
	...
	SALT BLOB,
	 ...
	 CONSTRAINT IDENTITIES_TYPE_CHK CHECK (identity_type IN ('X509', 'GSS', 'USERPASS', 'SSH', 'SAML', 'OIDC', 'OIDC_ALL')),
  ...
  CREATE TABLE ACCOUNT_MAP
   (	IDENTITY VARCHAR2(2048),
	...
	CREATED_AT DATE,
	 ...
	 CONSTRAINT ACCOUNT_MAP_ID_TYPE_CHK CHECK (identity_type IN ('X509', 'GSS', 'USERPASS', 'SSH', 'SAML', 'OIDC', 'OIDC_ALL')) ,
